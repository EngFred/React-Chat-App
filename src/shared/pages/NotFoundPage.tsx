 ...
 * @description A component that displays a 404 "Page Not Found" error.
 * It provides a clear message and a link to navigate back to the login page.
...
const NotFoundPage: React.FC = () => {
  return (
    ...
    >
      ...
      >
        <Link
          to="/" // Link back to the login page
